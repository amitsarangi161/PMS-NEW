            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="empcodeno"class="form-control" id="inputEmail3" placeholder="Entry Time" value="{{$editdailyattendancegroup->entrytime}}">
                  </div>
                </div>
                <div class="form-group">
                  <label  class=" col-sm-3">DEPARTURE TIME</label>
                  <div class="col-sm-9">
                    <input type="text" name="qualification"class="form-control" id="inputEmail3" value="{{$editdailyattendancegroup->departuretime}}" placeholder="Departure Time">
                  </div>
                </div>
                 <div class="form-group">
