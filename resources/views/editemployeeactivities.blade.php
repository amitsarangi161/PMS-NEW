...
<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/updaateemployeactivities/{{$emplyeeactivity->id}}">
 {{ csrf_field() }}
...
<tr>
      	 ...
      	 <td>
             ...
             <option value="{{$user->id}}" {{ ( $user->id == $emplyeeactivity->employeeid) ? 'selected' : '' }}>{{$user->name}}</option>
...
<tr>
<td colspan="4"><button class="btn btn-success" style="float: left;" type="submit">UPDATE ACTIVITY</button><a href="/"><button class="btn btn-danger" style="float: right;" type="button" >Cancel</button></a></td>
</tr>
