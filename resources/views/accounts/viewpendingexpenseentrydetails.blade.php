  ...
  <div class="table-responsive">
    <table class="table">
      ...
      <td>
      	...
      	<a href="/reports/transactionreport?fromdate=& todate=& user={{$expenseentry->userid}} &projectname=& status=" style="color: #333;"><strong>TOTAL PAID AMOUNT TILL DATE :</strong>  {{$totalamt}}</a>@else<strong>TOTAL PAID AMOUNT TILL DATE :</strong>  {{$totalamt}}@endif</td>
