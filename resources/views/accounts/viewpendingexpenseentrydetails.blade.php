  ...
  <div class="table-responsive">
    <table class="table">
     ...
     <td>
      	...
      	<a href="/reports/transactionreport?fromdate=& todate=& user={{$expenseentry->userid}} &projectname=& status=" style="color: #2e1a93;text-decoration:underline;"><strong>TOTAL PAID AMOUNT TILL DATE :</strong>  {{$totalamt}}</a>
