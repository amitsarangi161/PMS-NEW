...
<table class="table table-responsive table-hover table-bordered table-striped datatable1">
	...
	<tbody>
		...
		<tr style="font-size: 13px;">
			  <td><a href="/viewpendingrequisition/{{$requisition->id}}" class="btn btn-success">{{$requisition->id}}</a></td>
			  ...
			  @else
			    <td></td>
			  @endif
              <td><a href="/viewpendingrequisition/{{$requisition->id}}" class="btn btn-info">VIEW</a></td>
